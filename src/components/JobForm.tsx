...
import { faEnvelope, faPhone, faPhotoFilm, faUser } from '@fortawesome/free-solid-svg-icons';
    ...
    <Theme>
      <form action={handleSaveJob} className="container mt-6 flex flex-col gap-4">
        ...
        <div className="grid sm:grid-cols-3 gap-6 *:grow">
          ...
          <div>
            Full time?
            <RadioGroup.Root defaultValue={jobDoc?.type || 'project'} name="type">
          ...
          <div>
            Salary
            <TextField.Root name="salary" defaultValue={jobDoc?.salary || '0'}>
        ...
        <div className="sm:flex">
          <div className="w-1/3">
            ...
            <ImageUpload name="jobIcon" icon={faPhotoFilm} defaultValue={jobDoc?.jobIcon || ''} />
          </div>
